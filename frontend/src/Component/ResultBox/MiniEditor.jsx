  ...
  return (
    <>
      ...
      <div className="s-Editor">
        <div className="s-codeWindows">
          <div className="s-htmlbox" id="html">
            <CodeMirror
              className="s-htmlCode"
              value={htmlCode}
          ...
          <div className="s-cssbox none" id="css">
            <CodeMirror
              className="s-cssCode"
              value={cssCode}
          ...
          <div className="s-jsbox none" id="js">
            <CodeMirror
              className="s-jsCode"
              value={jsCode}
